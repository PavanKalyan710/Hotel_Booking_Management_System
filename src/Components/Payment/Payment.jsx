        ...
        <Flex justifyContent={"space-between"}>
          ...
          <Box w={{ base: "100%", md: "100%", lg: "67%" }}>
            ...
            <Box
              ...
              <HStack mt={"30px"}>
                <Text fontWeight={"700"}>{traveller} x Customor</Text>
                <Spacer />
                <HStack>
                  <IconButton
            ...
            <Box
              ...
              <HStack
                ...
                <HStack
                  ...
                  <Text>
                    {" "}
                    Customor details should match information on National Id
                  </Text>
                </HStack>
              </HStack>
                  ...
                  <ModalContent w={"350px"} top={"22%"} py={"30px"}>
                    <ModalBody>
                      ...
                      <VStack>
                        ...
                        <Text fontSize={"15px"}>
                          Thank You for booking on Dreamy Destination.
                        </Text>
            ...
            <Box
              ...
              <Text mt={"25px"} lineHeight={"19px"} fontSize={"13px"}>
                Dreamy Destination is an authorised Agent of Expat Explore.
                Please familiarise yourself with the Expat Explore 
                payment, cancellation and refund policies and Dreamy Destination's Terms
                & Conditions. Dreamy Destination will charge you in the stated currency
